...
class Bottleneck(nn.Module):
    def __init__(self, c1, c2, shortcut=True, g=1, e=1.0):  # ch_in, ch_out, shortcut, groups, expansion
        ...
        self.cv1 = ConvNormAct(c1, c_, kernel_size=1, stride=1, padding=0, norm_layer=nn.BatchNorm2d,
                               act_layer=nn.ReLU)
        self.cv2 = RepConvN(c_, c2, kernel_size=3, stride=1, padding=1, groups=g)
